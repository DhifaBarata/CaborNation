...
Penting: Verifikasi bahwa MySQL Anda berjalan di Port 3307.
Buat database baru dengan nama: cabornation.
Import file .sql dari folder /database/ ke database cabornation.
Perhatian Kritis: Pastikan tabel tournament_registrations memiliki kolom status dengan nilai pending, accepted, dan rejected.
# 3. Konfigurasi Koneksi PHP
Sesuaikan file konfigurasi database, biasanya di config.php (terletak di /php/config.php):
...
# 5. Akses Aplikasi
Pindahkan semua file proyek ke folder htdocs XAMPP Anda.
Akses aplikasi melalui browser: http://localhost/cabornation/
